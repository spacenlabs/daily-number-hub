-- Add unique constraint to game_results_history for conflict handling
ALTER TABLE public.game_results_history 
ADD CONSTRAINT unique_game_result_date UNIQUE (game_id, result_date);
